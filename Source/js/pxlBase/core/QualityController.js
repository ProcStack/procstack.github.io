...
export class QualityController{
	constructor( pxlTimer, pxlCookie, mobile=false, searchParms=null){
		...
		this.fpsCounter=new THREE.Vector3(30, 0, (new Date().getTime())*.001);; // [ Cur FPS, Frame Count Since Last FPS Check, Last FPS Sample Time ]
		this.countAtLevel=0,
		this.shiftRate=.01;
        ...
        this.detailLimitOverride= searchParms.get('dlimit');
