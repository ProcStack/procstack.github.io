import*as n from"../../three.module.js";function b(){return`
    #ifdef GL_FRAGMENT_PRECISION_HIGH
      precision highp float;
    #else
      precision mediump float;
    #endif
        `}import*as S from"../../three.module.js";function D(){let r=b();return r+=`
    ...
    void main(){
        ...
        gl_FragColor=Cd;
    }`}import*as x from"../../three.module.js";var L=x.Vector2,T=x.Vector3;var W={NONE:0,ERROR:1,WARN:2,INFO:3},j={OFF:0,LOW:1,MEDIUM:2,HIGH:3},$={OFF:0,VAPOR:1},X={OFF:0,BASIC:1,SOFT:2};var Q={verbose:W.NONE,pxlRoomRoot:"./pxlRooms",staticCamera:!1,autoCamera:!1,antiAliasing:j.LOW,shadowMapBiasing:X.BASIC,LoadEnvAssetFile:!1,skyHaze:$.OFF,loaderPhrases:["...loading the pixels..."]};import*as d from"../../three.module.js";import*as C from"../../three.module.js";function O(r=!1){let e=`
    attribute vec3 color;
    ...
    void main(){
        ...
        `,r&&(e+=`
          ...
          `),e+=`
    }`,e}function z(r,e,t,i,o,s){let a=!1,f=1;r.hasOwnProperty("Specular")&&r.Specular>0&&(a=!0,f=r.Specular);let v=!1;r.PointColor&&(v=!0);let m=!0,h="1.0";r.hasOwnProperty("SurfaceNoise")&&(r.SurfaceNoise%1==0&&(h=r.SurfaceNoise+".0"),h=="0.0"&&(m=!1));let l=`
    ...
    `,i&&(l+=`
      ...
      `),l+=`
    void main(){
      `,v)l+="vec3 vertCd = vCd;";else if(e){let c=_=>_%1==0?_+".0":_+"",N=c(e.r),B=c(e.g),G=c(e.b);l+=`vec3 vertCd = vec3( ${N}, ${B}, ${G} ) ;`}else l+="vec3 vertCd = texture2D(dTexture,vUv).rgb ;";l+=`
        ...
        `,t&&(l+=`
          ...
          `);let y="",p="",E="";if(m&&(h!="1.0"&&(y="*"+h),l+=`
            float detailMult = (texture2D(detailTexture,vUv*4.0).r)*.5+.5;
            `,p=`+detailMult * (shadowInf*.5+.5) ${y}`,E=`(detailMult+.5) ${y}`),i&&(l+=`
