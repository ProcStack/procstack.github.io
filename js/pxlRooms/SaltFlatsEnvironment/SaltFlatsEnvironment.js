import*as n from"../../three.module.js";function E(){return`
    #ifdef GL_FRAGMENT_PRECISION_HIGH
      precision highp float;
    #else
      precision mediump float;
    #endif
        `}import*as S from"../../three.module.js";function _(){let a=E();return a+=`
    ...
    void main(){
        ...
        gl_FragColor=Cd;
    }`}import*as x from"../../three.module.js";var L=x.Vector2,T=x.Vector3;var W={NONE:0,ERROR:1,WARN:2,INFO:3},j={OFF:0,LOW:1,MEDIUM:2,HIGH:3},Z={verbose:W.NONE,pxlRoomRoot:"./pxlRooms",staticCamera:!1,autoCamera:!1,antiAliasing:j.LOW,LoadEnvAssetFile:!1};import*as d from"../../three.module.js";import*as C from"../../three.module.js";function z(a=!1){let e=`
    attribute vec3 color;
