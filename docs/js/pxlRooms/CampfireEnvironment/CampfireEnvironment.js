...
const BillowSmoke = pxlBase.pxlEffects.BillowSmoke;
const EmberWisps = pxlBase.pxlEffects.EmberWisps;
const FloatingDust = pxlBase.pxlEffects.FloatingDust;
...
export class CampfireEnvironment extends RoomEnvironment{
  ...
  fbxPostLoad(){
    console.log("CampfireEnvironment Post Load");
    super.fbxPostLoad();
