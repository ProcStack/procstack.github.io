...
export const pageListingData = {
  ...
  'content' : `
    ...
    <div class='procPagesAboutMe-infoStyle'>
      ...
      <br><br> <span class="innerCenter textBold textBump">Index</span>

      <br> AI Architectures : <span class='aiDevPage-innerLink' data-tag='rnn'>RNN</span> | <span class='aiDevPage-innerLink' data-tag='Gated-Recurrent-Unit-GRU'>GRU</span> | <span class='aiDevPage-innerLink' data-tag='Long-Short-Term-Memory-LSTM'>LSTM</span> | <span class='aiDevPage-innerLink' data-tag='Generative-Adversarial-Network-GAN'>GAN</span> | <span class='aiDevPage-innerLink' data-tag='Echo-State-Network-ESN'>ESN</span> | <span class='aiDevPage-innerLink' data-tag='Graph-Neural-Network-GNN'>GNN</span> | <span class='aiDevPage-innerLink' data-tag='Graph-Attention-Network-GAT'>GAT</span> | <span class='aiDevPage-innerLink' data-tag='Enhanced-Super-Resolution-GAN-ESRGAN'>ESRGAN</span>

      <br><br> General Terms : <span class='aiDevPage-innerLink' data-tag='Attention-Head'>Attention Head</span> | <span class='aiDevPage-innerLink' data-tag='Attention-Mechanism'>Attention Mechanism</span> | <span class='aiDevPage-innerLink' data-tag='Convolution-Convolve'>Convolution</span> | <span class='aiDevPage-innerLink' data-tag='Convolutional-Layer'>Convolutional Layer</span> | <span class='aiDevPage-innerLink' data-tag='Discriminator'>Discriminator</span> | <span class='aiDevPage-innerLink' data-tag='Training-Epochs'>Epochs</span> | 
      <span class='aiDevPage-innerLink' data-tag='Fully-Connected-Layer'>Fully Connected</span> | <span class='aiDevPage-innerLink' data-tag='Generator'>Generator</span> | <span class='aiDevPage-innerLink' data-tag='Graph-Node'>Graph Node</span> | <span class='aiDevPage-innerLink' data-tag='Heuristics'>Heuristics</span> | <span class='aiDevPage-innerLink' data-tag='Hidden-StateLayer'>Hidden State</span> | 
      <span class='aiDevPage-innerLink' data-tag='Laplacian-Pyramids'>Laplacian Pyramids</span> | <span class='aiDevPage-innerLink' data-tag='Feature-Landmark'>Landmark</span> | <span class='aiDevPage-innerLink' data-tag='Meta-Learning'>Meta-Learning</span> | <span class='aiDevPage-innerLink' data-tag='Perceptual-Loss'>Perceptual Loss</span> | <span class='aiDevPage-innerLink' data-tag='Pooling-Layer'>Pooling Layer</span> | <span class='aiDevPage-innerLink' data-tag='Projection'>Projection</span> | <span class='aiDevPage-innerLink' data-tag='Rabbit-Hole'>Rabbit Hole</span> | 
      <span class='aiDevPage-innerLink' data-tag='Residual'>Residual</span> | <span class='aiDevPage-innerLink' data-tag='Residual-Block'>Residual Block</span> | <span class='aiDevPage-innerLink' data-tag='Time-Session-step'>Time/Session</span> | <span class='aiDevPage-innerLink' data-tag='Vanishing-Gradients'>Vanishing Gradients</span>

      <br><br> My Terms :
      <br>&nbsp;&nbsp; <span class='aiDevPage-innerLink' data-tag='dPA-MPNN'>dPA-MPNN</span> | <span class='aiDevPage-innerLink' data-tag='d-'>d-</span> | 
      <span class='aiDevPage-innerLink' data-tag='Lighthouse'>Lighthouse</span> | <span class='aiDevPage-innerLink' data-tag='Time'>Time</span> | 
      <span class='aiDevPage-innerLink' data-tag='The-Particle-System'>The Particle System</span>

      <br><br><br><div class='procPagesAIDevBar'></div>

      <br><br> <span class="innerCenter textBold textBump">AI Terms</span>

      <br> <span class="textName" id="rnn"> Recurrent Neural Network (RNN) </span>
      ...
      <br><br> <span class="textName" id="Time-Session-step"> Time / Session step </span>
      ...
      <br><br> <span class="textName" id="Hidden-StateLayer"> Hidden State/Layer </span>
      ...
      <br><br> <span class="textName" id="Training-Epochs"> Training Epochs </span>
      <br>&nbsp;&nbsp; A complete pass through the entire training dataset while the neural network learns.
      
      <br><br> <span class="textName" id="Meta-Learning"> Meta-Learning </span>
      <br>&nbsp;&nbsp; Learning how to learn.
      <br>&nbsp;&nbsp;&nbsp;&nbsp; It's the core result of solid heuristic based ai development.
      
      <br><br> <span class="textName" id="Heuristics"> Heuristics </span>
      ...
      <br><br> <span class="textName" id="Rabbit-Hole"> Rabbit Hole </span>
      ...
      <br><br> <span class="textName" id="Echo-State-Network-ESN"> Echo State Network (ESN) </span>
      ...
      <br><br> <span class="textName" id="Gated-Recurrent-Unit-GRU"> Gated Recurrent Unit (GRU) </span>
      ...
      <br><br> <span class="textName" id="Long-Short-Term-Memory-LSTM"> Long Short-Term Memory (LSTM) </span>
      ...
      <br><br> <span class="textName" id="Vanishing-Gradients"> Vanishing Gradients </span>
      ...
      <br><br> <span class="textName" id="Generative-Adversarial-Network-GAN"> Generative Adversarial Network (GAN) </span>
      <br>&nbsp;&nbsp; A type of neural network architecture that trains two competing networks;
      <br>&nbsp;&nbsp;&nbsp;&nbsp; A Generator and Discriminator AI
      
      <br><br> <span class="textName" id="Generator"> Generator </span>
      ...
      <br><br> <span class="textName" id="Discriminator"> Discriminator </span>
      ...
      <br><br> <span class="textName" id="Enhanced-Super-Resolution-GAN-ESRGAN"> Enhanced Super Resolution GAN (ESRGAN) </span>
      ...
      <br><br> <span class="textName" id="Perceptual-Loss"> Perceptual Loss </span>
      ...
      <br><br> <span class="textName" id="Residual"> Residual </span>
      <br>&nbsp;&nbsp; The difference between the input and output of a layer in a neural network.

      <br><br> <span class="textName" id="Residual-Block"> Residual Block </span>
      ...
      <br><br> <span class="textName" id="Graph-Neural-Network-GNN"> Graph Neural Network (GNN) </span>
      ...
      <br><br> <span class="textName" id="Graph-Attention-Network-GAT"> Graph Attention Network (GAT) </span>
      ...
      <br><br> <span class="textName" id="Attention-Mechanism"> Attention Mechanism </span>
      ...
      <br><br> <span class="textName" id="Attention-Head"> Attention Head </span>
      ...
      <br><br> <span class="textName" id="Convolution-Convolve"> Convolution / Convolve </span>
      ...
      <br><br> <span class="textName" id="Convolutional-Layer"> Convolutional Layer </span>
      ...
      <br><br> <span class="textName" id="Pooling-Layer"> Pooling Layer </span>
      ...
      <br><br> <span class="textName" id="Laplacian-Pyramids"> Laplacian Pyramids </span>
      ...
      <br><br> <span class="textName" id="Feature-Landmark"> Feature / Landmark </span>
      ...
      <br><br> <span class="textName" id="Fully-Connected-Layer"> Fully Connected Layer </span>
      ...
      <br><br> <span class="textName" id="Projection"> Projection </span>
      ...
      <br><br> <span class="textName" id="Graph-Node"> Graph Node </span>
      ...
      <br> <span class="textName" id="dPA-MPNN"> dPA-MPNN </span>
      ...
      <br><br> <span class="textName" id="d-"> d- </span> ... <span class="textName" id="dGAT"> dGAT </span> <span class="textName" id="dESN"> dESN </span> <span class="textName"> ... </span>
      ...
      <br><br> <span class="textName" id="Lighthouse"> Lighthouse </span>
      ...
      <br><br> <span class="textName" id="Time"> Time </span> / <span class="textName"> Memory </span> / <span class="textName"> ESN** </span>
      ...
      <br><br> <span class="textName" id="The-Particle-System"> The Particle System </span>
