...
export const pageListingData = {
  ...
  'content' : `
    ...
    <div class="procPagesProjectsDescriptionStyle">A full drawing/painting app on desktop, a fun fidget toy on mobile.
    ...
    <div class="procPagesProjectsSmallDescStyle">Use the mixing pallet to blend colors together to paint with, then save the pallet by pressing a number key.
