...
export const pageListingData = {
  ...
  'media' : [
    ...
    {
      'type' : 'image',
      'src' : '../pages/projects/images/TechDev_characterColorAnim_dataNormal_sm.webp',
      'alt' : 'Character Color Animation Data Texture',
      'style' : 'procPagesImageStyle',
      'caption' : ["Character Color Data, Light Normals, & Animation Atlases", "Each row is a different armor/class type.", "Each column is a frame of Idle, Walk, or Talk animations."]
    },
    {
      'type' : 'video',
  ...
  'content' : `
    ...
    <br>&nbsp;&nbsp; You can find a more developed version on Steam & Itch.io
    <br>&nbsp;&nbsp;&nbsp;&nbsp; With future plans if we gain more interest!
    
    <br>
    <br>&nbsp;&nbsp; Get <span class="textName textBump textBold">Currents of War</span> on <a href='https://store.steampowered.com/app/4072230/Currents_of_War/' class='procPagesRepoLinkStyle' target='_blank'>Steam</a> -or- <a href='https://ellipsis9.itch.io/currents-of-war' class='procPagesRepoLinkStyle' target='_blank'>Itch.io</a>
    <br><br>  
    ...
    <br> <span class="textNudge">For <span class="textBump">art inspiration</span>, I looked to</span> -
    <br><br>&nbsp;&nbsp; <span class="textBump">Gameboy Advance</span> games like <span class="textName textBump textBold">Zelda Minish Cap</span>,
    <br>&nbsp;&nbsp;&nbsp;&nbsp; <span class="textItalic">Everything should be outlined with similar color hues blended!</span>
    <br><br>&nbsp;&nbsp; <span class="textBump">Super Nintendo</span> games like <span class="textName textBump textBold">Secret of Mana</span> & <span class="textName textBump textBold">Final Fantasy 3/6</span>,
    <br>&nbsp;&nbsp;&nbsp;&nbsp; <span class="textItalic">Fantasy character designs with reason for the details</span>
    <br><br>&nbsp;&nbsp; <span class="textBump">Original Nintendo</span> games like <span class="textName textBump textBold">River City Ransom</span>.
    <br>&nbsp;&nbsp;&nbsp;&nbsp; <span class="textItalic">Character proportions & vibes.</span>
    <br>
    ...
    <br><br><br>&nbsp;&nbsp; <span class="textItalic">yeah <span class="textNudge">photoshop</span> for pixel art
    <br>&nbsp;&nbsp;&nbsp;&nbsp; pencil & mask layers</span>
    <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="textItalic textItch">use what you know best!</span>
