import*as s from"../../../Source/js/libs/three/three.module.js";import*as C from"../../../Source/js/libs/three/three.module.js";function R(n=!1){let e=`
    ...
    `,i&&(l+=`
      ...
      `),l+=`
    void main(){
      `,u)l+="vec3 vertCd = vCd;";else if(e){let p=_=>_%1==0?_+".0":_+"",N=p(e.r),V=p(e.g),G=p(e.b);l+=`vec3 vertCd = vec3( ${N}, ${V}, ${G} ) ;`}else l+="vec3 vertCd = texture2D(dTexture,vUv).rgb ;";l+=`
    ...
    #endif
        `}import*as T from"../../../Source/js/libs/three/three.module.js";function z(){return`
