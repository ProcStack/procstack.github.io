import*as l from"../../../Source/js/libs/three/three.module.js";function g(){return`
    ...
    #endif
        `}import*as S from"../../../Source/js/libs/three/three.module.js";function A(){let r=g();return r+=`
  ...
  void main(){
    ...
    void main() {
      ...
      gl_FragColor = outCd;
    }`,r}import*as b from"../../three.module.js";var w=b.Vector2,T=b.Vector3;var ie={NONE:0,ERROR:1,WARN:2,INFO:3},ae={OFF:0,LOW:1,MEDIUM:2,HIGH:3},le={verbose:ie.NONE,pxlRoomRoot:"./pxlRooms",staticCamera:!1,autoCamera:!1,antiAliasing:ae.LOW,LoadEnvAssetFile:!1};import*as p from"../../../Source/js/libs/three/three.module.js";import*as P from"../../../Source/js/libs/three/three.module.js";function Y(r=!1){let e=`
    attribute vec3 color;
