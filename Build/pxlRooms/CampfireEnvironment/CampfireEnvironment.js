import*as l from"../../three.module.js";function g(){return`
    ...
    #endif
        `}import*as S from"../../three.module.js";function A(){let r=g();return r+=`
  ...
  void main(){
    ...
    void main() {
      ...
      gl_FragColor = outCd;
    }`,r}import*as b from"../../three.module.js";var w=b.Vector2,T=b.Vector3;var ie={NONE:0,ERROR:1,WARN:2,INFO:3},ae={OFF:0,LOW:1,MEDIUM:2,HIGH:3},re={OFF:0,VAPOR:1},se={OFF:0,BASIC:1,SOFT:2};var de={verbose:ie.NONE,pxlRoomRoot:"./pxlRooms",staticCamera:!1,autoCamera:!1,antiAliasing:ae.LOW,shadowMapBiasing:se.BASIC,LoadEnvAssetFile:!1,skyHaze:re.OFF,loaderPhrases:["...loading the pixels..."]};import*as p from"../../three.module.js";import*as P from"../../three.module.js";function $(r=!1){let e=`
    attribute vec3 color;
