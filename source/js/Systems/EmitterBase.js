...
class EmitterBase{
  ...
  constructor( State ){
    ...
    this.Fields={
      CIRCLE : 0, // Local; Single Player
      SQUARE : 1, // Local; Single Player
      PLAYER : 2, // Online; Multi Player
    }
    //this.fieldType = this.Fields.CIRCLE;
    this.fieldType = this.Fields.SQUARE;
    
    this.centroid = [ this.State.sW*.5, this.State.sH*.5 ];
		this.centroidPrev = [ ...this.centroid ];
